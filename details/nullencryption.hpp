...
#ifndef dnp3sav6_details_nullencryption_hpp
...
public :
	...
	virtual ~NullEncryption() = default;

	NullEncryption(NullEncryption const&) = delete;
	NullEncryption(NullEncryption &&) = delete;
	NullEncryption& operator=(NullEncryption const&) = delete;
	NullEncryption& operator=(NullEncryption &&) = delete;
